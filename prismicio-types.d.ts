...
/**
 * Item in *Bento → Default → Primary → Boxs*
 */
export interface BentoSliceDefaultPrimaryBoxsItem {
  /**
   * Title field in *Bento → Default → Primary → Boxs*
   *
   * - **Field Type**: Title
   * - **Placeholder**: *None*
   * - **API ID Path**: bento.default.primary.boxs[].title
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  title: prismic.TitleField;

  /**
   * Body field in *Bento → Default → Primary → Boxs*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: bento.default.primary.boxs[].body
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  body: prismic.RichTextField;

  /**
   * Image field in *Bento → Default → Primary → Boxs*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: bento.default.primary.boxs[].image
   * - **Documentation**: https://prismic.io/docs/field#image
   */
  image: prismic.ImageField<never>;

  /**
   * Wide field in *Bento → Default → Primary → Boxs*
   *
   * - **Field Type**: Boolean
   * - **Placeholder**: *None*
   * - **Default Value**: false
   * - **API ID Path**: bento.default.primary.boxs[].wide
   * - **Documentation**: https://prismic.io/docs/field#boolean
   */
...
export interface BentoSliceDefaultPrimary {
  ...
  /**
   * Boxs field in *Bento → Default → Primary*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: bento.default.primary.boxs[]
   * - **Documentation**: https://prismic.io/docs/field#group
   */
  boxs: prismic.GroupField<Simplify<BentoSliceDefaultPrimaryBoxsItem>>;
}
...
/**
 * Primary content in *Heros → Default → Primary*
 */
export interface HerosSliceDefaultPrimary {
  /**
   * Heading field in *Heros → Default → Primary*
   *
   * - **Field Type**: Title
   * - **Placeholder**: *None*
   * - **API ID Path**: heros.default.primary.heading
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  heading: prismic.TitleField;

  /**
   * Body field in *Heros → Default → Primary*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: heros.default.primary.body
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  body: prismic.RichTextField;

  /**
   * Button Link field in *Heros → Default → Primary*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: heros.default.primary.button_link
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
  button_link: prismic.LinkField;

  /**
   * Button Label field in *Heros → Default → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: heros.default.primary.button_label
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  button_label: prismic.KeyTextField;

  /**
   * Image field in *Heros → Default → Primary*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: heros.default.primary.image
   * - **Documentation**: https://prismic.io/docs/field#image
   */
  image: prismic.ImageField<never>;
}
...
/**
 * Item in *Integrations → Default → Primary → Zone*
 */
export interface IntegrationsSliceDefaultPrimaryZoneItem {
  /**
   * Icon field in *Integrations → Default → Primary → Zone*
   *
   * - **Field Type**: Select
   * - **Placeholder**: *None*
   * - **API ID Path**: integrations.default.primary.zone[].icon
...
export interface IntegrationsSliceDefaultPrimary {
  ...
  /**
   * Zone field in *Integrations → Default → Primary*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: integrations.default.primary.zone[]
   * - **Documentation**: https://prismic.io/docs/field#group
   */
  zone: prismic.GroupField<Simplify<IntegrationsSliceDefaultPrimaryZoneItem>>;
}
...
export interface ShowcaseSliceReversePrimary {
  ...
  /**
   * button_text field in *Showcase → Reverse → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
  ...
  /**
   * Button_link field in *Showcase → Reverse → Primary*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      AllDocumentTypes,
      BentoSlice,
      BentoSliceDefaultPrimaryBoxsItem,
      ...
      HerosSliceDefault,
      IntegrationsSlice,
      IntegrationsSliceDefaultPrimaryZoneItem,
