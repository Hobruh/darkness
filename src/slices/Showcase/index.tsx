...
const Showcase = ({ slice }: ShowcaseProps): JSX.Element => (
  <Bounded
    ...
    className="relative"
    >
      <div className="glow absolute -z-10 aspect-square w-full max-w-xl rounded-full bg-red-400/30 blur-3xl filter" />
  ...
  <AnimatedContent>
    ...
    <div className="grid mt-16 items-center rounded-xl border border-blue-50/20 bg-gradient-to-b from-slate-50/15 to-slate-50/5 px-8 py-8 backdrop-blur-sm lg:grid-cols-3 lg:py-12 md:grid-cols-2 sm:py-6 xs:grid-cols-1">
    <div>  
